...
module.exports = ({ fabric }) => {
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, {
    ...
    setYxExtCursorForDefaultBrush () {
      fabric.Image.fromURL(require('./assets/ico_cursor_brush.png'), (oImg) => {
        this.setYxExtCursor(oImg);
      });
    },
    setYxExtCursorForDefaultEraser () {
      fabric.Image.fromURL(require('./assets/ico_cursor_eraser.png'), (oImg) => {
        this.setYxExtCursor(oImg);
      });
    },
