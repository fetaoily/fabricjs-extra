...
module.exports = ({ fabric }) => {
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, {
    ...
    setDrawingModeForEraser ({ width = 30, color = this.backgroundColor }) {
      ...
      this.isDrawingModeForShapes = false;
      this.freeDrawingBrush = !color ? fabric.YxExtEraserBrush && new fabric.YxExtEraserBrush(this) : fabric.YxExtEraserBrushV2 && new fabric.YxExtEraserBrushV2(this);
      this.freeDrawingBrush.width = width;
     ...
     * @param shapeType
     */
    setDrawingModeForShapes ({ width = 30, color = '#000000', shapeType }) {
